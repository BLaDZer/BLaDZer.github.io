    ...
    [3282], {
        ...
        46069: function(e, t, r) {
            ...
            var n = r(20406),
                ...
                v = function(e) {
                    ...
                    function i() {
                        var e;
                        return (0, c.Z)(this, i), r.call(this, {
                            transform: (e = (0, n.Z)(f().mark(function e(t, r) {
                                return f().wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            ...
                                            return r.error(new b.T1("StreamError message received: ".concat(JSON.stringify(t)), t.data)), e.abrupt("return");
                                        case 3:
                                            if ("cancel" !== t.event) {
                                                e.next = 6;
                                                break
                ...
                j = ["streamId", "lastEventId", "interactionId"],
                y = ["headers"];
            ...
            var w = function(e) {
                    ...
                    function n(e) {
                        var t;
                        return (0, c.Z)(this, n), (t = r.call(this)).timeout = e, t
                    }
                    return (0, a.Z)(n)
                }((0, d.Z)(Error)),
                P = function(e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        r = m.v.API_HOST + "/ai/chatCompletion",
                        n = {
                            "Content-Type": "application/json"
                        };
                    return t.streamId && (n["gamma-chat-completion-stream-id"] = t.streamId), A(r, {
                        method: "POST",
                        headers: n,
                ...
                k = function(e) {
                    var t = e.streamId,
                        ...
                        n = e.interactionId,
                        i = (0, o.Z)(e, j),
                        a = new URL(m.v.API_HOST + "/ai/resumeChatCompletion");
                    return a.searchParams.set("interactionId", n), A(a.toString(), {
                        method: "GET",
                        headers: {
                ...
                A = function(e, t, r) {
                    var i, a = r.retries || 0,
                        c = r.backoff || 1e3,
                        s = r.timeout || null,
                        u = null !== (i = r.streamResumingEnabled) && void 0 !== i && i,
                        l = 0,
                        ...
                        P = !1,
                        k = function() {
                            return c * Math.pow(2, Math.max(l - 1, 0))
                        },
                        A = {};
                    return u && (A["gamma-stream-resuming-enabled"] = "true"), {
                        stream: new h.Pz({
                            start: function(r) {
                                return (0, n.Z)(f().mark(function i() {
                                    var c, h;
                                    return f().wrap(function(i) {
                                        for (;;) switch (i.prev = i.next) {
                                            case 0:
                                                null != s && (x = setTimeout(function() {
                                                    P = !0, d.abort(), r.error(new b.rm("Stream timed out after ".concat(s, "ms")))
                                                }, s)), c = t.headers, h = (0, o.Z)(t, y), (0, g.L)(e, O(O({
                                                    openWhenHidden: !0,
                                                    credentials: "include"
                                                }, h), {}, {
                                                    headers: O(O({}, c), A),
                                                    ...
                                                    onopen: function() {
                                                        var e = (0, n.Z)(f().mark(function e(t) {
                                                            return f().wrap(function(e) {
                                                                for (;;) switch (e.prev = e.next) {
                                                                    case 0:
                                                                        if (!(t.ok && t.headers.get("content-type") === g.a)) {
                                                                            e.next = 4;
                                                                            break
                                                                        }
                                                                    ...
                                                                    case 4:
                                                                        ...
                                                                        d.abort(), r.error(new b.VG("Unable to complete request")), e.next = 15;
                                                                        break;
                                                                    case 9:
                                                                        if (!(l++ < a && !p)) {
                                                                            e.next = 13;
                                                                        ...
                                                                        throw new w(k());
                                                                    case 13:
                                                                        d.abort(), r.error(new b.VG("Unable to complete request"));
                                                                    case 15:
                                                                    case "end":
                                                                        return e.stop()
                                                                }
                                                    ...
                                                    onmessage: function(e) {
                                                        if (j) {
                                                            m || (m = !0, console.log("[AIStream] enqueue cancel event", O(O({}, e), {}, {
                                                                event: "cancel",
                                                                data: ""
                                                            })), r.enqueue(O(O({}, e), {}, {
                                                                event: "cancel",
                                                    ...
                                                    onclose: function() {
                                                        x && (clearTimeout(x), x = null), r.close()
                                                    },
                                                    onerror: function(e) {
                                                        if (e instanceof w) {
                                                            if (j) throw console.error("Stream cancelled - not retrying"), Error("Stream cancelled");
                                                            return e.timeout
                                                        }
                                                        if (e instanceof Error) {
                                                            if (console.error("Uncaught stream error", e), !u) throw e;
                                                            if (l++ < a) return k();
                                                            throw e
                                                        }
                                                        if (p) {
                                                            var t = "Stream closed unexpectedly";
                                                            throw console.error("Uncaught stream error", t), new b.Vh(t)
                                                        }
                                                    }
                                                })).catch(function(e) {
                                                    x && (clearTimeout(x), x = null), j || r.error(e)
                                                });
                                            case 3:
                                            case "end":
                                                return i.stop()
        ...
        51495: function(e, t, r) {
            ...
            var j = function(e) {
                ...
                var b = null !== (t = (0, p.ye)("aiDebits")[r]) && void 0 !== t ? t : g.Sy[r];
                return (0, h.jsx)(d.kH, {
                    label: (0, h.jsx)(a.cC, {
                        id: "B7jvsP",
                        values: {
                ...
                v = function(e) {
                    ...
                    return (0, g.jsxs)(o.v, {
                        children: [(0, g.jsx)(a.j, {
                            ...
                            textAlign: "left",
                            children: null === (t = m.find(function(e) {
                                return e.key === i
            ...
            var n = r(68089),
                ...
                Y = (0, y.memo)(function(e) {
                    var t = e.image,
                        r = e.isSelected,
                        n = e.onImageClick,
                        i = e.resizeThumbnail ? (0, D.SN)(t.thumbnailUrl, {
                            width: 250,
                            height: 250
                        }) : t.thumbnailUrl,
        ...
        25299: function(e, t, r) {
            ...
            var J = r(26673),
                ...
                eP = function(e) {
                    ...
                    function n(e) {
                        var t, i;
                        return (0, ev.Z)(this, n), t = r.call(this, {
                            start: function() {
                                var t;
                                null === (t = e.onStart) || void 0 === t || t.call(e)
                            },
                            transform: (i = (0, eu.Z)(eg().mark(function r(n, i) {
                                var o, a, c;
                                return eg().wrap(function(r) {
            ...
            var eS = r(44934),
                eC = r(3907),
                eE = r(88914),
                eD = (n = (0, eu.Z)(eg().mark(function e(t) {
                    var r, n, i, o;
                    return eg().wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return r = "".concat(eE.v.API_HOST || "https://api.gamma.app", "/media/images/generate"), e.next = 3, fetch(r, {
                                    method: "POST",
                                    headers: {
                                        "Content-Type": "application/json"
                                    },
                            ...
                            case 7:
                                throw i = e.sent, o = "".concat(i.error, ": ").concat(i.message), new eI(o, i);
                            case 10:
                ...
                eI = function(e) {
                    ...
                    function n(e, t) {
                        var i;
                        return (0, ev.Z)(this, n), i = r.call(this, e, t), (0, s.Z)((0, ey.Z)(i), "response", void 0), i.response = t, i
                    }
                    return (0, ej.Z)(n)
                }((0, eC.Z)(Error));
            eI.prototype.name = "GenerateImageError";
            var e_ = r(26909),
                eU = r(53776),
                eR = new e_.V({
                    systemPromptOperation: eU.Run.GenerateImagePromptSystem,
                    userPromptOperation: eU.Run.GenerateImagePromptUser,
            ...
            var eB = function(e) {
                            ...
                            return eg().wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        ...
                                        }, e.prev = 7, (0, P.hq)(s), e.next = 11, eD(eG({
                                            interactionId: o,
                                            docId: n,
                                    ...
                                    case 15:
                                        u.length > 0 && (y(u), r(u[0])), (0, eS.d)("generateImage"), (0, P.o)(eG(eG({}, s), {}, {
                                        ...
                                        break;
                                    case 20:
                                        e.prev = 20, e.t0 = e.catch(7), f(!0), (null === (d = e.t0.response) || void 0 === d ? void 0 : d.code) === "prohibited_input" && e.t0.response.categories && ((p = e.t0.response.categories).sexual || p["sexual/minors"] ? m("sexual") : p.violence || p["violence/graphic"] ? m("violence") : m("prohibited")), l(!1), console.error("(caught) [AIGenerateImage] error:", e.t0), (0, P.pQ)(eG(eG({}, s), {}, {
                                            latency: performance.now() - a,
                ...
                eQ = function(e, t) {
                    var r, n = (0, w.useCallback)(function() {
                            if (!e) return null;
                            var t = e.state.selection,
                                r = (0, eH.Ru)(t.$from, eN.KH)[0],
                                n = r && (0, eM.NE)(r.node, r.pos),
                        ...
                        i = (r = eG(eG({}, t), {}, {
                            ...
                            generate: (0, w.useCallback)(function(e) {
                                var t = e.variables,
                                    n = e.interactionId,
                                    i = e.params,
                                    o = e.workspaceId;
                                ...
                                return {
                                    ...
                                    promise: new Promise(function(e, t) {
                                        (0, eb.GO)(d, {
                                            onError: function(e) {
                                                var n;
                                                null === (n = r.onError) || void 0 === n || n.call(r, e), t(e)
                                            },
                                            onDone: function() {
                                                e(l.getContent())
                                            }
                ...
                eY = {
                    ...
                    push: function(e, t) {
                        return "" === eV(e).trim() ? this.replace(e, t) : {
                    ...
                    select: function(e, t) {
                        return e.ind === e.history.length - 1 && eV(e) === t ? e : this.push(e, t)
                    }
                },
                eK = function() {
                    var e = (0, w.useRef)(!1),
                        ...
                        i = (0, w.useCallback)(function(t, r) {
                            "load" === r && n(function(e) {
                                ...
                                return eY.replace(e, t)
                            })), "select" === r && n(function(e) {
                                return eY.select(e, t)
                            }), e.current = "update" !== r
                        }, []),
                ...
                e3 = function(e) {
                    var t = e4[0].presets[0];
                    return e4.forEach(function(r) {
                ...
                e6 = (0, w.memo)(function(e) {
                    ...
                    return (0, F.jsx)(er.NI, {
                        children: (0, F.jsxs)(e0.J, {
                            placement: "bottom-start",
                            matchWidth: !0,
                            isOpen: o,
                            onClose: c,
                            closeOnBlur: !0,
                            children: [(0, F.jsx)(e1.x, {
                                children: (0, F.jsx)(j.z, {
                                    width: "100%",
                                    type: "button",
                                    boxShadow: "none",
                                ...
                                overflowY: "auto",
                                children: (0, F.jsx)(e5.b, {
                                    children: (0, F.jsx)(d.g, {
                                        spacing: 4,
                                        children: e4.map(function(e) {
                                            return (0, F.jsxs)(d.g, {
                                                align: "start",
                                                spacing: 0,
                                                children: [(0, F.jsx)(v.X, {
            ...
            e6.displayName = "StylePresetMenu";
            var e8 = function(e) {
                    var t = e.preset,
                        r = e.onClick,
                        n = e.isSelected;
                        ...
                        m = (0, w.useCallback)(function(e, t) {
                            if (e.aiParams) {
                                var r = e.aiParams,
                                    ...
                                    s = Object.values(e7).find(function(e) {
                                        return e.height === o && e.width === a
                                    });
                                s && l(s.key), i && n(i, t), c && f(e3(c).preset)
                            }
                        }, [n]);
                    return {
                        prompt: r,
                        ...
                        children: (0, F.jsxs)(en.v, {
                            children: [(0, F.jsx)(ei.j, {
                                ...
                                children: (0, F.jsx)(ea._, {
                                    ...
                                    children: Object.values(e7).map(function(e) {
                                        return (0, F.jsx)(ec.i, {
                                            value: e.key,
                                            children: (0, F.jsxs)(b.U, {
                                                spacing: 2,
            ...
            tt.displayName = "AspectRatioSelect";
            var tr = r(50646),
                tn = r(61166),
                ti = r(77399),
                to = function() {
                ...
                tc = r(67784),
                ts = r(83484),
                tu = ["promptPageInfo", "nextPrompt", "prevPrompt", "isDisabled"];
                                ...
                                children: [(0, F.jsxs)(d.g, {
                                    ...
                                    children: [(0, F.jsx)(v.X, {
                                        ...
                                        children: [(0, F.jsxs)(j.z, {
                                            ...
                                            variant: "ghost",
                                            justify: "flex-end",
                                            segmentEvent: tf.AA.GAMMA_UPSELL_CALLOUT_AI_CREDITS_IMAGES
                                        })]
                                    })]
                                })]
                            }), s && (0, F.jsx)(G, {
            ...
            var tZ = {
                ...
                tF = r(38421),
                tW = r.n(tF),
                tG = ["funny", "surprise", "hooray", "welcome", "excited", "nope", "fail", "sad", "cry", "angry", "teamwork", "cats", "dogs", "high five"],
                tB = {
                    key: "image.giphy",
                    Panel: function(e) {
                        var t = e.updateAttributes,
                ...
                description: function() {
                    return o.ag._({
                        ...
                        values: {
                            ...
                            GAMMA_ARTIFACT_PROPER_NOUN: C.Yc
                        }
                    })
                },
                icon: tq.Uu,
            ...
            var t8 = {
                ...
                t7 = ["wallpaper", "textures", "background", "nature", "gradient", "relax", "sky", "water", "pattern", "abstract"],
                t9 = {
                    key: "image.lexica",
                    Panel: function(e) {
                        var t = e.updateAttributes,
            ...
            var rn = w.lazy(function() {
                    return Promise.all([r.e(7576), r.e(3982)]).then(r.bind(r, 73982)).then(function(e) {
                        return {
                            default: e.LoomPanel
                        }
                    })
                ...
                ri = {
                    ...
                    Panel: function(e) {
                        return (0, F.jsx)(w.Suspense, {
                            ...
                            children: (0, F.jsx)(rn, function(e) {
                                for (var t = 1; t < arguments.length; t++) {
                                    var r = null != arguments[t] ? arguments[t] : {};
            ...
            var rb = {
                ...
                ry = {
                    ...
                    preferHtml: !0,
                    rewriteEmbedUrl: function(e) {
                        var t, r = null === (t = e.match(rj)) || void 0 === t ? void 0 : t[1];
            ...
            var rP = {
                ...
                rk = r(90002),
                rA = "Unsplash",
                rS = ["wallpaper", "textures", "architecture", "background", "nature", "gradient", "experimental", "animals", "california", "flowers", "relax", "sky", "water", "pattern", "abstract"],
                rC = {
                    key: "image.unsplash",
                    Panel: function(e) {
                        var t = e.updateAttributes,
                ...
                rU = {
                    ...
                    Panel: function(e) {
                        ...
                        return (0, F.jsxs)(d.g, {
                            ...
                            }), c && a && (0, F.jsxs)(F.Fragment, {
                                children: [(0, F.jsx)(r_.X, {
                                    isChecked: i,
                                    onChange: function(e) {
                                        return r({
                ...
                rM = [tR, tB, t$, rD, t9, rC, rT, ri, tz, tJ, tY, rU, tH.i, tv, ro, rf, rx, rE, tN, rp, ra, tE, tD, rR, rg, ry, t2, t5.j, tZ, rP, t8, rb],
                rZ = Object.fromEntries(Object.values(rM).flat().map(function(e) {
                    return [e.key, e]
                }))
        },
            ...
            var u = 47.5,
                l = o()(function(e) {
                    var t, r = e.isPresentMode,
                        ...
                        j = e.userZoomLevel,
                        y = e.isMobileDevice,
                        x = "none" !== v.background.type && !i,
                        O = l || !i && (a || r && !b),
                        w = O || i ? "0em" : y ? "".concat(.5, "em") : "".concat(2, "em"),
                        P = O || i ? "0em" : y ? "".concat(.5, "em") : !x || r || l ? "".concat(2, "em") : "8em",
                        k = i ? o * c.GG : 0,
                        A = null !== (t = h.config.fontSize) && void 0 !== t ? t : 1,
                        S = (r || l ? m.aspectRatio ? g : f : y ? p : d)({
                            userZoomLevel: j,
                            baseFontSize: A * (y ? 1 : 1.125),
                            contentWidthEms: (u ? 120 : 95) * (.5 / A),
                            nestedBulgeEms: k,
                    ...
                    return function(e) {
                        ...
                        "--card-outer-padding-y": P,
                        "--comment-padding": "var(--card-inner-padding-x)",
                        "--nested-card-margin": "calc(-1 * var(--comment-padding) - ".concat(k, "em)"),
                        "--border-radius-override": O ? "none" : "var(--undefined)",
                        "--card-vertical-align": m.defaultVerticalAlign,
                        "--char-width-multiple": "".concat(1 / A)
                    }, S)
                }),
                d = function(e) {
                ...
                p = function(e) {
                    var t = e.contentWidthEms,
                        ...
                        a = e.isFullBleed;
                    return {
                        "--card-inner-padding-y": "".concat(i ? 2.25 : 1.5 + (a ? 1 : 0), "em"),
                        "--card-inner-padding-x": "".concat(1.5, "em"),
                        "--font-size": "".concat(n, "rem"),
                        "--card-width": "".concat(t + 3 + 2 * r, "em"),
                        "--card-min-height": o ? "calc(min(var(--card-width), var(--editor-width)) / ".concat(o, ")") : void 0
                    }
                },
                f = function(e) {
                    var t = e.userZoomLevel,
                        ...
                        u = e.isThumbnail,
                        l = r + 7.5 + 2 * n,
                        d = a.Pv ? "".concat(c * t, "rem") : "calc(".concat(t, " * clamp(").concat(u ? "0rem" : "1rem", ", var(--card-max-width) / ").concat(l, ", 2.7vh))"),
                        p = !i || o;
                    return {
                        "--card-inner-padding-x": "".concat(3.75, "em"),
                        "--card-inner-padding-y": "".concat(2.75, "em"),
                        "--font-size": d,
                        "--card-width": p ? "var(--editor-width)" : "".concat(l, "em"),
                        "--card-max-width": "calc(var(--editor-width) - 2 * var(--card-outer-padding-x))",
                        "--card-min-height": !p || s || u ? "0vh" : "100vh",
                        "--max-content-width": "".concat(r, "em")
                    }
                },
                g = function(e) {
                    var t = e.cardAspectRatio,
                        ...
                        i = e.nestedBulgeEms,
                        o = e.isThumbnail,
                        c = a.Pv ? "calc(var(--card-max-width) / ".concat(t, ")") : "calc(100vh - 2 * var(--card-outer-padding-y))",
                        s = "calc(".concat(n, " * min(var(--card-max-width), calc(var(--card-max-height) * ").concat(t, ")))"),
                        u = "calc(var(--card-width) / ".concat(t, ")"),
                        l = a.Pv || o ? "0px" : "15px",
                        d = "calc((var(--card-width) - ".concat(l, ") / ").concat(r + 7.5 + 2 * i, ")");
                    return {
                        "--card-inner-padding-x": "".concat(3.75, "em"),
                        "--card-inner-padding-y": "".concat(2.75, "em"),
                        "--card-width": s,
        ...
        89641: function(e, t, r) {
            ...
            var p = function(e) {
                ...
                f = function(e) {
                    var t = e.layout,
                        r = e.parentCards;
                    return (0, c.s2)() && p(t) ? "mobileStacked" : p(t) && g(r) ? "blank" : t
                },
                g = function(e) {
                    return e.some(function(e) {
                        return p(e.attrs.layout)
                    })
                },
                h = function(e) {
                    var t = m(e),
                ...
                m = function(e) {
                    return u.q[null != e ? e : "blank"] || u.q.blank
                },
                b = function(e) {
                    var t = {},
                        r = e.pos,
                ...
                y = function(e, t, r, n) {
                    var i = r.nodes.cardLayoutItem.createAndFill(d({
                        itemId: "body"
                    }, n));
                    e.insert(t + 1, i)
                },
                x = function(e, t, r, n) {
                    var i = r.nodes.cardAccentLayoutItem.createAndFill(d({
                        itemId: "accent",
                        background: {
                            type: o.E.NONE
                        }
                ...
                O = function(e, t, r, n) {
                    ...
                    if (0 === Object.keys(o).length) {
                        j(e, {
                            node: i,
                            pos: t
                        }, r), n.items.accent && x(e, t, r);
                        return
                    }
                    n.items.body && !o.body && y(e, t, r), n.items.accent && !o.accent ? x(e, t, r) : o.accent && "cardLayoutItem" === o.accent.node.type.name && w(e, o.accent.pos, o.accent.node, r)
                },
                w = function(e, t, r, n) {
                    e.replaceRangeWith(t, t + r.nodeSize, n.nodes.cardAccentLayoutItem.createAndFill(d({}, r.attrs)))
                },
                P = function(e) {
        ...
        13282: function(e, t, r) {
            ...
            var e6 = {
                ...
                e8 = function(e) {
                    ...
                    return (0, B.jsxs)(s.k, {
                        ...
                        children: [(0, B.jsx)(l.Global, {
                            styles: {
                                "#__textLabelMeasure, #__textMeasure": e3({}, w)
                            }
                        }), (0, B.jsxs)(R.Provider, {
                            value: f || {},
                            children: [(0, B.jsx)(o.Dr, e3(e3({
                                onAssetCreate: y,
                                onAssetDelete: x
                            }, n), {}, {
                ...
                te = function(e) {
                    ...
                    if (0 !== r.length) {
                        var i = e7.cQ.getCommonBounds(r.map(o.D9.getRotatedBounds));
                        if (i) {
                            var a = o.D9.getCameraZoom(Math.min((n.width - t) / i.width, (n.height - t) / i.height)),
                                c = (n.width - i.width * a) / 2 / a,
                                s = (n.height - i.height * a) / 2 / a;
                            e.setCamera(e9.B.toFixed(e9.B.sub([c, s], [i.minX, i.minY])), a, "zoomed_to_fit")
                        }
                    }
                }
        },
        57643: function(e, t, r) {
            r.d(t, {
                c: function() {
                    return a
                },
...
//# sourceMappingURL=3282-3737fa0c00ef4327.js.map